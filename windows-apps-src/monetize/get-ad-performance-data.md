...
|---------------|--------|-----------------|----------|
| applicationId   | string    | The Store ID of the app for which you want to retrieve ad performance data. The Store ID is available on the [App identity page](../publish/view-app-identity-details.md) of the Dev Center dashboard. An example Store ID is 9NBLGGH4R315. |    No      |
