...
To use map services in apps for Windows Phone 8.1 and earlier, you need a map service application ID and a token to include in your app's code. You can get this token in the Dev Center dashboard by navigating to the **Maps** page in your app's **Services** section.
...
> **Note**  You don’t have to finish submitting your app at this time. After you request a token and ID, the info will be saved on this page. You can return to this page at any time to view this info.
